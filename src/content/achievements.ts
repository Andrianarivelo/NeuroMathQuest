...
export const achievements: Achievement[] = [
  ...
  { id: 'ach_seventy',      title: 'Full Journey',        description: 'Complete every lesson in the app.',   icon: 'trophy', target: 190 },
  ...
  { id: 'ach_brain_basics', title: 'Brain Basics',        description: 'Complete the Neuroscience Basics track.', icon: 'brain', target: 40 },
