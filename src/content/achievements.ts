...
export const achievements: Achievement[] = [
  ...
  { id: 'ach_seventy',      title: 'Full Journey',        description: 'Complete every lesson in the app.',   icon: 'trophy', target: 70 },
  ...
  { id: 'ach_math_basics',  title: 'Math Mind',           description: 'Complete the Math Foundations track.',    icon: 'leaf',  target: 20 },
  { id: 'ach_compneuro',    title: 'Computational Thinker', description: 'Complete the Computational Neuroscience track.', icon: 'brain', target: 30 },
