...
function titleFromModuleId(id: string): string {
  const titles: Record<string, string> = {
    ...
    'A-microstructure': 'Neural microstructure',
    'A-learning': 'Learning and stability',
    'A-development': 'Development and experience',
    'A-networks': 'Brain networks and state',
    'A-body': 'Brain-body loops',
    'A-health': 'Brain health and disease',
    'A-science': 'Reading the evidence',
...
function descriptionFromModuleId(id: string): string {
  const descriptions: Record<string, string> = {
    ...
    'A-microstructure': 'Spines, myelin, and intracellular logistics.',
    'A-learning': 'How synapses change while circuits stay stable.',
    'A-development': 'How experience shapes circuits across time.',
    'A-networks': 'Connectomes, resting networks, and global brain state.',
    'A-body': 'Pain, interoception, autonomic control, and stress.',
    'A-health': 'Circuit views of inflammation, degeneration, and mental health.',
    'A-science': 'How to judge neuroscience claims from evidence.',
